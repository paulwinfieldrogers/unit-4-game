...
var computerGuess = Random=Math.floor(Math.random()* 102) + 19;
// 120-19+1 = 102 -this is the random result of computer guess btw 19-120
var crystalRandom1 = Random=Math.floor(Math.random()* 12) + 1; //one for each crystal
var crystalRandom2 = Random=Math.floor(Math.random()* 12) + 1; //one for each crystal
var crystalRandom3 = Random=Math.floor(Math.random()* 12) + 1; //one for each crystal
var crystalRandom4 = Random=Math.floor(Math.random()* 12) + 1; //one for each crystal
var userWins = 0;
var userLosses = 0;
...
//On click need to set var = itself plus total so far
    $('#cristal1').click(function(){
        ...
        //this number is for debugging only - it will not be visible to user
        ...
        if (userTotalGuess === computerGuess){
            ...
            userTotalGuess = 0;
            crystalRandom1 = Random=Math.floor(Math.random()* 12) + 1; //one for each crystal
            crystalRandom2 = Random=Math.floor(Math.random()* 12) + 1; //one for each crystal
            crystalRandom3 = Random=Math.floor(Math.random()* 12) + 1; //one for each crystal
            crystalRandom4 = Random=Math.floor(Math.random()* 12) + 1; //one for each crystal
